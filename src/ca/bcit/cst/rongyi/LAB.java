...
public class LAB {
    ...
    public static LAB fromFXColor(Color color) {
        return LAB.fromRGB((int) (color.getRed() * 256), (int) (color.getGreen() * 256), (int) (color.getBlue() * 256), 1.0);
    }
    ...
    public static double ciede2000(LAB x, LAB y) {
        ...
        // compute terms
        double pi = Math.PI, L1 = x.L, a1 = x.a, b1 = x.b, Cab1 = Math.sqrt(a1 * a1 + b1 * b1), L2 = y.L, a2 = y.a,
                b2 = y.b, Cab2 = Math.sqrt(a2 * a2 + b2 * b2), Cab = 0.5 * (Cab1 + Cab2),
        ...
        double Lpm502 = (Lp - 50) * (Lp - 50), Sl = 1 + 0.015 * Lpm502 / Math.sqrt(20 + Lpm502), Sc = 1 + 0.045 * Cp,
